    ...
    public function packageBooted()
    {
        ...
        FilamentAsset::register(
            assets: [
                ...
                Css::make('calendar-styles', 'https://cdn.jsdelivr.net/npm/@event-calendar/build@3.7.2/event-calendar.min.css'),
                Js::make('calendar-script', 'https://cdn.jsdelivr.net/npm/@event-calendar/build@3.7.2/event-calendar.min.js'),
            ],
