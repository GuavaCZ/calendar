    ...
    public function packageBooted()
    {
        ...
        FilamentAsset::register(
            assets: [
                ...
                Css::make('calendar-styles', 'https://cdn.jsdelivr.net/npm/@event-calendar/build@3.3.0/event-calendar.min.css'),
                Js::make('calendar-script', 'https://cdn.jsdelivr.net/npm/@event-calendar/build@3.3.0/event-calendar.min.js'),
            ],
