...
class CalendarView implements Arrayable, Eventable
{
    protected string $type;

    protected Carbon $currentStart;

    protected Carbon $currentEnd;
    protected Carbon $activeStart;

    protected Carbon $activeEnd;
